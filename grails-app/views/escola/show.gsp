...
<html>
    ...
    <body>
        ...
        <div id="show-escola" class="content scaffold-show" role="main">
            ...
            <f:display bean="escola" />
            <g:form resource="${this.escola}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.escola}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
